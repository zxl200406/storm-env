...
params="-Xmx3072m -Xms2048m -Xmn1024m -Xloggc:$run_dir/stdout/supervisor_gc_${start_time}.log -XX:MaxDirectMemorySize=1024m -XX:MaxPermSize=512m -XX:+DisableExplicitGC -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=$log_dir -XX:+PrintGCApplicationStoppedTime -XX:+PrintGCApplicationConcurrentTime -XX:+UseConcMarkSweepGC -XX:CMSInitiatingOccupancyFraction=80 -XX:+UseMembar -verbose:gc -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:+PrintGCDateStamps -XX:ParallelGCThreads=16 -XX:ConcGCThreads=16 -Dlogfile.name=supervisor.log -Dstorm.home=$run_dir -Dstorm.log.dir=$run_dir/logs -Djava.library.path="/opt/soft/jdk/lib:/opt/soft/jre/lib:/usr/local/lib" -Dlogback.configurationFile=$run_dir/cluster.xml -Dstorm.log.level=info -Djava.security.krb5.conf=$run_dir/krb5.conf backtype.storm.daemon.supervisor "
